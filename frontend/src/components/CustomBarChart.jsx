...
//                         <p className="font-bold text-gray-800">Attended: ({attendedClasses}/{totalClasses})</p>
//                         <p className="font-bold text-gray-800">{attendancePercentage}%</p>
//                     </>
//                 ) : (
//                     <>
//                         <h2 className="font-bold text-black">{subName.subName}</h2>
//                         <p className="font-bold text-gray-800">Marks: {marksObtained}</p>
//                     </>
//                 )}
//             </div>
//         );
